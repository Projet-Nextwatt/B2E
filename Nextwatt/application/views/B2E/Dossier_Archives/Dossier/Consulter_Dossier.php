        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="panel panel-success">
                    ...
                    <?php $this->fonctionspersos->creerTableau($dossiers, array(), 'CI_User/modif_user') ?>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="panel panel-success">
                    ...
                    <?php $this->fonctionspersos->creerTableau($dossiers_archive, array(), 'CI_User/modif_user') ?>
                </div>
            </div>
        </div>
    </div>
